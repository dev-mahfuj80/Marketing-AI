    ...
    try {
      ...
      try {
        ...
        if (contentType && contentType.includes("application/json")) {
          ...
          if (response.ok) {
            ...
            console.log(
              "Response was successful despite not being JSON, continuing..."
            );
            ...
            if (state && state.startsWith("http")) {
              ...
              if (debug) {
                console.log(
                  `Authentication successful! Redirecting to state URL: ${state}`
                );
              }
              ...
              if (debug) {
                console.log(
                  `Authentication successful! Redirecting to ${redirectUrl}`
                );
              }
      ...
      if (
        ...
        userFriendlyErrorMessage =
          "Authentication server is not running or unreachable";
      }
