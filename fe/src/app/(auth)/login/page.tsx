    ...
    <div className="min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-md space-y-8">
        <div className="text-center">
          ...
          <p className="text-muted-foreground mt-2">Sign in to your Marketing AI Dashboard</p>
        </div>
        ...
        <div className="text-center mt-6">
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <Button variant="outline" onClick={() => window.location.href = "http://localhost:3001/auth/facebook"}>
                Facebook
              </Button>
              <Button variant="outline" onClick={() => window.location.href = "http://localhost:3001/auth/linkedin"}>
                LinkedIn
              </Button>
            </div>
          </div>
