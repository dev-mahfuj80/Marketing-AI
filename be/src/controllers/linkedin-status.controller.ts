    ...
    try {
      ...
      if (!env.LINKEDIN_CLIENT_ID || !env.LINKEDIN_CLIENT_SECRET) {
        return res.status(200).json({
          ...
          permissionNote:
            "Please add LinkedIn client ID and secret to your environment variables",
          nextSteps:
      ...
      if (env.LINKEDIN_ACCESS_TOKEN) {
        try {
          ...
          tokenStatus.valid = await this.linkedinService.validateAccessToken(
            ...
            try {
              ...
              if (
                ...
                const organizationId =
                  organizationResponse.data.elements[0].organizationalTarget
                    .split(":")
                    .pop();
                ...
                return res.status(200).json({
                  ...
                  permissions: [
                    ...
                    },
                    {
                      ...
                      description:
                        "Create and manage organization social posts",
                      status: "granted",
                    },
                    {
              ...
              console.error(
                "Error getting LinkedIn organization info:",
                orgError
              );
      ...
      if (tokenStatus.valid && env.LINKEDIN_ACCESS_TOKEN) {
        ...
        try {
          const orgPostsResponse = await axios.get(
            "https://api.linkedin.com/v2/ugcPosts?q=authors&authors=List(urn%3Ali%3Aorganization%3A123)&count=1",
            {
              headers: {
                Authorization: `Bearer ${env.LINKEDIN_ACCESS_TOKEN}`,
                "X-Restli-Protocol-Version": "2.0.0",
          ...
          console.warn(
            "LinkedIn org posts access check failed:",
            orgPostsError
          );
          permissionDetails["r_organization_social"] = {
            name: "r_organization_social",
        ...
        try {
          ...
          const orgWriteResponse = await axios.post(
          ...
          if (
            orgWriteResponse.status === 201 ||
            orgWriteResponse.status === 200
          ) {
      ...
      const permissionsList =
        Object.values(permissionDetails).length > 0
      ...
      const hasPostPermissions = availablePermissions.includes(
      ...
      return res.status(200).json({
        ...
        permissionNote:
          credentialsValid && !tokenStatus.valid
        ...
        authUrl: credentialsValid
          ? `https://www.linkedin.com/oauth/v2/authorization?response_type=code&client_id=${
            ...
            )}&scope=r_liteprofile%20r_emailaddress%20r_organization_social%20w_organization_social%20rw_organization_admin`
          : null,
